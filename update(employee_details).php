...
<tr>
<td><input type="checkbox" name="f" value="DOB" >Date of birth</input>
</tr>
<tr>
...
<tr>
<td><input type="checkbox" name="f" value="Adress" >Adress</input>
</tr>
<tr>
<td><input type="checkbox" name="f" value="Email" >Email</input>
</tr>
</table>
<br>
...
$sql="update employee_details set $field='$ui' where E_id='$info'";
